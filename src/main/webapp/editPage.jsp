...
<form class="info" id="edit-form" action="PageEditController" method="post">
    ...
    <div class="half-width">
        <input type="text" id="ed-form-input" required list="education-form" name="educationForm" index="5" placeholder="Форма обучения:"><span id="er5" class="error hidden"></span>
    ...
    <div class="half-width">
    <input type="text" required id="graduation-year" class="half-width" name="graduationYear" index="6" placeholder="Год выпуска:" value="${sessionScope.userData.education.graduationYear}"/><span id="er6" class="error hidden"></span>
    </div>
